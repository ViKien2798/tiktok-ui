...
import { QRIcon, UserIcon, XMarkIcon, ChevronDownIcon } from '~/components/Icons';
        ...
        () => [
            {
                ...
                contents: [
                    ...
                    },
                    {
                        ...
                        title: 'Continue width Facebook',
                    },
                    {
                        icon: <img src={images.google} alt="" />,
                        title: 'Continue width Google',
                    },
                    {
                        icon: <img src={images.twitter} alt="" />,
                        title: 'Continue width Twitter',
                    },
                    {
                        icon: <img src={images.line} alt="" />,
                        title: 'Continue width LINE',
                    },
                    {
                        icon: <img src={images.kakaotalk} alt="" />,
                        title: 'Continue width KakaoTalk',
                    },
                    {
                        icon: <img src={images.apple} alt="" />,
                        title: 'Continue width Apple',
                    },
                    {
                        icon: <img src={images.instagram} alt="" />,
                        title: 'Continue width Instagram',
                    },
                ],
            },
            {
